...
FLOW_DEFINITION: dict = {
    ...
    "steps": [
        ...
        },
        {
            ...
            "description": "Angiv det samlede antal ansatte i virksomheden. Dette bruges til at fastsætte jeres medlemskabstier.",
            "fields": [
                {
                    "field_id": "employee_count",
                    "type": "number",
                    "label": "Antal fuldtidsansatte",
                    "required": True,
                    "validation": {"min": 0},
                    "hint": "1–9 ansatte = Mikro · 10–49 = SMV · 50+ = Erhverv",
                },
            ],
            "blocking_options": None,
            "next_step": 5,
        ...
        },
        {
            ...
            "description": "Angiv de relevante kontaktpersoner i virksomheden. Administrerende direktør er påkrævet.",
            "fields": [
                {
                ...
                },
                {
                    "field_id": "hr_contact",
                    "type": "contact_person",
                    "label": "Primær HR-kontakt (personalejura)",
                    "required": False,
                },
                {
                ...
                },
                {
                    ...
                    "type": "contact_person",
                    "label": "Anden tegningsberettiget (hvis ikke adm. dir.)",
                    "required": False,
                },
            ],
            "blocking_options": None,
